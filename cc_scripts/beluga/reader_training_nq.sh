...
train_files=$SCRATCH/DPR-data/data/retriever_results/nq/single/train.json \
dev_files=$SCRATCH/DPR-data/data/retriever_results/nq/single/dev.json \
...
output_dir=$SCRATCH/DPR-data/new-checkpoints
