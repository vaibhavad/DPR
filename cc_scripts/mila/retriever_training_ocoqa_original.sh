...
#SBATCH --job-name=dpr_train_dense_encoder_biencoder_ocoqa_original
...
train_datasets=[ocoqa_train_original] \
dev_datasets=[ocoqa_test_original] \
train=biencoder_nq output_dir=$SCRATCH/DPR-data/new-checkpoints/ocoqa/original/retriever
