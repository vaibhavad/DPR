...
#SBATCH --job-name=dpr_train_dense_encoder_biencoder_ocoqa_rewrites_t5_qrecc
...
train_datasets=[ocoqa_train_rewrites_t5_qrecc] \
dev_datasets=[ocoqa_test_rewrites_t5_qrecc] \
train=biencoder_nq output_dir=$SCRATCH/DPR-data/new-checkpoints/ocoqa/rewrites_t5_qrecc/retriever
