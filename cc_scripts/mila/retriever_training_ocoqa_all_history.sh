...
#SBATCH --job-name=dpr_train_dense_encoder_biencoder_ocoqa_all_history
...
train_datasets=[ocoqa_train_all_history] \
dev_datasets=[ocoqa_test_all_history] \
train=biencoder_nq output_dir=$SCRATCH/DPR-data/new-checkpoints/ocoqa/all_history/retriever
